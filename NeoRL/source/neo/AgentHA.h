		...
		struct LayerDesc {
			...
			*/
			LayerDesc()
				...
				_scActiveRatio(0.05f), _scBoostAlpha(0.00004f),
				_predWeightAlpha(0.01f),
				_qAlpha(0.004f), _qBiasAlpha(0.004f), _qLambda(0.95f), _qRadius(4), _qReluLeak(0.01f)
			{}
		};
	...
	public:
		...
		*/
		AgentHA()
			...
			_qLastAlpha(0.0004f), _qLastBiasAlpha(0.0004f), _qLastLambda(0.95f), _qLastRadius(8),
