	...
	*/
		...
		struct LayerDesc {
			...
			*/
			LayerDesc()
				...
				_qAlpha(0.001f), _qBiasAlpha(0.001f), _qLambda(0.95f), _qRadius(6),
				_noise(0.05f)
			{}
		};
	...
	public:
		...
		*/
		AgentHA()
			: _prevValue(0.0f),
			_qLastSize({ 16, 16 }), _qGamma(0.98f),
			_qLastAlpha(0.0001f), _qLastBiasAlpha(0.0001f), _qLastLambda(0.95f), _qLastRadius(8),
