	...
	std::mt19937 &rng)
{
	...
	for (int l = 0; l < _layers.size(); l++) {
		...
		_layers[l]._pred.createRandom(cs, program, predDescs, prevLayerState, initWeightRange, rng);
		...
		prevLayerState = _layerDescs[l]._size;
	}
